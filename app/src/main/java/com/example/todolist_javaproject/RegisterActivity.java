    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userLoginId=et_id.getText().toString();
                final String userPassword=et_pass.getText().toString();
                String userName=et_name.getText().toString();
                String userCompanyName=et_company.getText().toString();
                ...
                RegisterRequest registerRequest=new RegisterRequest(userLoginId, userPassword, userName, userCompanyName, responseListener);
                RequestQueue queue= Volley.newRequestQueue(RegisterActivity.this);
